        ...
        <div class="phone_login_container on">
          <section class="login_message_phone">
            <div class="J_input_warp">
              ...
              <input class="input_num" type="tel" maxlength="11" placeholder="请输入手机号" v-model="name"  name="name">
          ...
          <section class="login_message_on" v-show ="isShowSms">
            ...
            <input class="input_code" :type="isword" maxlength="8" placeholder="请输入密码" v-model="info">
              <div class="right-line"></div>
              <div id="left-line"></div>
          </section>
        <button class="J_login_submit" @click="login">登录</button>
