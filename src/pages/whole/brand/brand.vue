        ...
        <!--<li class="y_brand_project_item">
          <div class="y_brand_project_title">
            <div class="y_item_img">
              <img v-if="brandData.artistVO" :src="brandData.artistVO.headImg">
            </div>
            <div class="y_item_info">
              <div class="y_item_title_container">
                <span class="y_item_title" v-if="brandData.artistVO">{{brandData.artistVO.bname}}</span>
          ...
          <div class="y_brand_project_info">
            <div class="y_brand_project_info_container wrapper" ref="wrapper">
              <ul class="content">
                &lt;!&ndash;          单项内容    &ndash;&gt;
                <li><div class="y_project_item">
                  <div class="y_item_img">
                    <span>曲苑杂坛</span>
                    <img src="//img.alicdn.com/bao/uploaded/i2/2251059038/O1CN01RfYiqp2GdSCziBcJD_!!0-item_pic.jpg_q50.jpg_.webp">
                  </div>
                  <div class="y_item_info">
                    <p class="y_info_title">【北京】2019德云社北京相声大会-三庆园</p>
                    <p class="y_info_price"><span class="price">￥</span>100 <span>起</span></p>
                    <p class="y_info_want">261.1万人想看</p>
                  </div>
                </div></li>
                <li><div class="y_project_item">
                  <div class="y_item_img">
...
<script>
  ...
  import BrandItem from '../../../component/brandItem/brandItem'
...
<style scoped lang="stylus" rel="stylesheet/stylus">
  .y_brand_container
    .y_brand_project_list_container
      overflow hidden
      .y_brand_project_item
